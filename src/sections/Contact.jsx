...
export default function Contact() {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText('yashvardhansengar20@gmail.com');
    setCopied(true);
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                <a
                  href="mailto:yashvardhansengar20@gmail.com"
                  style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '20px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  <a
                    href="https://github.com/Yea-shDevs"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/yashvardhan-sengar-86210836a"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}
                    className="contact-item-hover"
