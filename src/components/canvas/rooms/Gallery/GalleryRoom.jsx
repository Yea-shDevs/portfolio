...
const FALLBACK_PROJECTS = [
    {
        ...
        description: 'A charming interactive Valentine\'s Day web experience featuring CSS animations, event-driven storytelling, and playful micro-interactions.',
    ...
    },
    {
        ...
        description: 'A fully functional grocery shopping web app with product listings, cart management, and a clean responsive UI — built with pure JavaScript.',
        techStack: ['/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/jslogo.webp']
    },
    {
        id: 'abtalksss',
        title: 'ABTALKS AI INTERVIEWER',
        front: '/textures/gallery/bioprzod.webp',
        painted: '/textures/gallery/bioprzod_painted.webp',
        url: 'https://a-btalks-ten.vercel.app',
        description: 'An AI-powered mock interview platform that simulates real interview sessions, giving instant feedback to help candidates sharpen their skills.',
    ...
    },
    {
        ...
        description: 'A TypeScript-first full stack web application built with clean architecture, type safety, and a modern user experience tailored for Indian users.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'bigbasket',
        ...
        description: 'A pixel-perfect frontend clone of BigBasket — India\'s largest online grocery platform — with a responsive multi-page layout and polished CSS architecture.',
        techStack: ['/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/jslogo.webp']
    }
];
