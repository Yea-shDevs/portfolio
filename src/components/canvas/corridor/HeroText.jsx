...
/**
 * HeroText Component - Custom styled for Yash
 */
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for YASH split effect (4 letters)
    const letters = useMemo(() => [
        { char: 'Y', baseX: -0.9, splitDir: -1.8 },
        { char: 'A', baseX: -0.3, splitDir: -0.6 },
        { char: 'S', baseX: 0.3, splitDir: 0.6 },
        { char: 'H', baseX: 0.9, splitDir: 1.8 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of YASH
