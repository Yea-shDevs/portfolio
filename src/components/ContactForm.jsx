...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      aria-label="Send a message to Yash"
    >
      ...
      {status === 'success' && (
        ...
        >
          Thank you! Your message was transmitted successfully. Yash will respond within 24 hours.
        </div>
      )}
      ...
      {status === 'error' && (
        ...
        >
          Something went wrong. Please try again or email directly at yashvardhansengar20@gmail.com
        </div>
      )}
